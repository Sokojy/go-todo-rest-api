...
// Login will compare email and password, and if
// everything well will return the user
...
// GetUserByID will return user by provided id
func GetUserByID(u uint) *User {
	user := &User{}
